...
Якщо ви знайшли помилку або хочете запропонувати покращення, створіть issue в [GitHub репозиторії](https://github.com/frontend-performance-assessor/frontend-performance-assessor/issues).
