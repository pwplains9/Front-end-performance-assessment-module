...
Якщо ви знайшли помилку або хочете запропонувати покращення, створіть issue в [GitHub репозиторії](https://github.com/pwplains9/frontend-performance-assessor/issues).
