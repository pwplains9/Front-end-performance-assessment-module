...
Если вы нашли ошибку или хотите предложить улучшение, создайте issue в [GitHub репозитории](https://github.com/pwplains9/frontend-performance-assessor/issues).
